    ...
    <div>
        ...
        <div>
          <div>
            ...
            <div>
              {playerHand.map((card, idx) => (
                <img key={idx} src={cardImagePath(card.value, card.suit)} alt={`${card.value} of ${card.suit}`} width={75} height={100} />
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            <div>
              ...
              {gameState === 'inProgress' && (
                <img src={require('./Assets/card_back.png')} alt="Hidden Card" width={75} height={100} />
              )}
            </div>
          </div>
      ...
      {gameState === 'finished' && (
        <div>
          ...
          <h2>{playerScore > 21 ? 'Player Busts! Dealer Wins!' : dealerScore > 21 ? 'Dealer Busts! Player Wins!' : playerScore > dealerScore ? 'Player Wins!' : 'Dealer Wins!'}</h2>
        </div>
      )}
    </div>
  );
